                ...
                <div id="form-total">
                    ...
                    <section>
                        <div class="inner">
                            ...
                            <div style="margin-bottom:20px;" class="form-row" >
                                <div class="col-6">
                                        <div style="padding-left:10px; margin-bottom:20px;" class="row">
                                            <p style="color:white;">Gender*</p>
                                            <div class="col-4">
                                                <div class="form-check" style="margin-right:20px;">
                                                    <input class="form-check-input gender" type="radio" value="male"
                                            ...
                                            <div class="col-4">
                                                <div class="form-check">
                                                    <input class="form-check-input gender" value="female" type="radio"
                                                           required name="gender">
                                                    <label style="color:white; font-weight:bold;" class="form-check-label"
                                                           for="gender">
                                                        Female
                            ...
                            <div class="form-row">
                                <div class="form-holder">
                                    ...
                                    <input type="number" onwheel="return false;" minlength="10" maxlength="12"
                                           placeholder="Enter Phone Number" class="form-control" id="phonenumber"
                                           name="phonenumber" required>
                                </div>
                                <div class="form-holder">
                                    <label for="confirm_password">ID Number*</label>
                                    <input type="number" onwheel="return false;" minlength="7" maxlength="8"
                                           placeholder="Enter ID Number" class="form-control" id="idnumber"
                    ...
                    <section>
                        ...
                        <div class="inner">
                            ...
                            <div style="margin-bottom:25px;" class="form-holder form-holder-2">
                                <label for="firstname" style="color:white; font-weight:bold; margin-bottom:10px;">Vehicle
                                    Fuel Type*</label>
                            ...
                            <div class="form-holder form-holder-2">
                                ...
                                <input type="text" placeholder="Enter Number Plate" class="form-control" id="regno"
                                       name="regno" style="text-transform: uppercase" required>
                            </div>
                            <div class="form-row row mt-3">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <p style="color:white; font-weight:bold; margin-bottom:30px;">Vehicle Picture</p>
                                    <img id="vehicle_image" class="img-fluid img-thumbnail" src=""
                                         style="border:2px solid white; width:200px; height:200px;" alt="Vehicle Photo">
                                </div>
                            </div>
                        ...
                        <div class="inner">
                            ...
                            <div class="card"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <span style="color:white; font-weight:bold;"
                                              class="card-subtitle mb-2 text-white">Gender:</span>
                                    ...
                                    <p class="card-text">
                                        <span style="color:white; font-weight:bold;"
                                              class="card-subtitle mb-2 text-white">ID Number:</span>
                                    ...
                                    <p class="card-text">
                                        <span style="color:white; font-weight:bold;"
                                              class="card-subtitle mb-2 text-white">Vehicle :</span>
                                        <span id="vehicle-val"></span>
                                    </p>

                                    <p class="card-text">
                                        <span style="color:white; font-weight:bold;"
                                              class="card-subtitle mb-2 text-white">Vehicle Fuel Type :</span>
                                        <span id="fuel-type"></span>
                                    </p>

                                    <p class="card-text">
                                        <span style="color:white; font-weight:bold;"
                                              class="card-subtitle mb-2 text-white">Registration Number :</span>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <img id="confirm-vehicle-image" src="front-end/images/car.jpg"
                                     class="img-fluid img-thumbnail"
                                     style="border:3px solid rgb(182, 173, 89); width:200px; height:200px;" alt="">
                            </div>
                        </div>
                    </section>
