                                ...
                                @foreach ( $sales as $sale )
                                    <tr>
                                            ...
                                            @if($sale->status == 'Accepted')
                                                <td class="align-middle text-center text-sm">
                                                    <button style="border:none;"
                                                            phone_number={{ $sale->phone_number }}  sale_id={{ $sale->id }}   class="salestatusbtn
                                            ...
                                            @else
                                                <td class="align-middle text-center text-sm">
                                                    <span style="cursor:pointer;"
                                                          phone_number={{ $sale->phone_number }}  sale_id={{ $sale->id }} class="salestatusbtn
                                                          badge badge-sm bg-gradient-secondary">Pending</span>
                                                </td>
                                            @endif
                                        @else
                                            <td class="text-sm">
                                        ...
                                        <td class="text-sm">
                                            ...
                                            <span style="cursor:pointer;" id="{{ $sale->id }}" style="background-color:#f9a14d;"
                                                    class="moresalesdetails badge badge-sm bg-gradient-info">more info
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-holder col-lg-6 col-md-12 col-sm-12 form-holder-2 mb-4">
                            <label for="regno">Customer Name & Phone Number</label></br>
                    ...
                    <div class="row">
                        <div id="sales_rejection_div" col-lg-6 col-md-12 col-sm-12 style="display:none;"
                             class="form-holder form-holder-2 mb-4">
                            <label for="regno">Reason for Rejection</label></br>
                            <p id="sale_rejection_reason" style="padding-left:5px;"></p>
                        </div>
                        <div class="form-holder col-lg-6 col-md-12 col-sm-12 form-holder-2 mb-4">
                            <label for="pump">Pump, Side</label></br>
                            <p id="pump" style="padding-left:5px;"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-holder col-lg-8 col-md-12 col-sm-12 form-holder-2 mb-4">
                            <label for="regno">Image</label></br>
                            <img id="vehicle_image" src="" style="border:4px solid grey; width:400px; height:400px;"
                                 alt="">
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="sales_reason_div" style="display:none;" class="form-holder form-holder-2 mt-4 mb-4">
                            ...
                            <textarea name="sales_status_reason" id="sale_status_reason"
