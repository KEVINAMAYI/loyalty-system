...
@section('content')
                        ...
                        <div class="row">
                                        ...
                                        <table class="table align-items-center mb-0">
                                            ...
                                            @foreach($petrol_monthly_rewards as $reward_monthly)
                                                <tr>
                                                    <td class="align-middle text-center text-sm">
                                                        <p style="text-align:left; padding-left:20px;"
                                                           class="text-xs font-weight-bold mb-0">{{ $reward_monthly->low }}
                                                            - {{ $reward_monthly->high }} </p>
                                                    </td>
                          ...
                          <span
                              class="text-secondary text-xs font-weight-bold">{{ $reward_monthly->price_period }}</span>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        <button id="{{ $reward_monthly->id }}"
                                                                style="border:0px; background-color:#3875b6;"
                                                                class="editmonthlyrewardbtn badge badge-sm">edit
                                                        </button>
                                                        {{-- <a href="/delete-cooperate-employee/" class="badge badge-sm bg-gradient-danger">delete</a> --}}
                                                    </td>
                                                </tr>
    ...
    <form action="/edit-monthly-reward" method="POST">
        @csrf
        <div class="modal fade" id="edit-monthly-reward" tabindex="-1" aria-labelledby="edit-monthly-reward"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div style="margin-top:10px; margin-left:10px; margin-right:10px; display:none;"
