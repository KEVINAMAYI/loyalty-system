                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <div style="text-align:right;">
                                <a style="background-color:#f9a14d;" href="/sales" type="button"
                                ...
                                <table data-ordering="false" id="dashboard_sales_table" class="table  mb-0">
                                    ...
                                    @foreach ($sales as $sale)
                                        <tr>
                                            ...
                                            <td class="text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $sale->rewards_used }}</span>
                                            </td>
                                            <td class="text-sm">
                                                    <span
                                            ...
                                            <td class="text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $sale->created_at }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <div style="text-align:right;">
                                <a style="background-color:#f9a14d; margin-bottom:20px;" href="/authorized-purchases"
                                   type="button" class="btn btn-primary btn-md"><i class="fa-solid fa-eye"></i>
                                    <span style="margin-left:5px;">View More</span></a>
                            </div>
                        </div>
                        <div class="card-body  px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table data-ordering="false" id="dashboard_authorization_table"
                                        ...
                                        @if(isset($authorized_purchase[0][0]))
                                            ...
                                            <td style="padding-left:20px;" class="align-middle text-left text-sm">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    ...
                                                    {{ $authorized_purchase[0][0]->last_name }}</p>
                                            </td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $authorized_purchase[1][0]->vehicle_type }}
                                                        {{ $authorized_purchase[1][0]->vehicle_registration }}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                    <span
                                            ...
                                            @if ($authorized_purchase[2]->status == 'complete')
                                                <td class="align-middle text-center text-sm">
                                                        <span
                                                            class="badge badge-sm bg-gradient-success">{{ $authorized_purchase[2]->status }}</span>
                                                </td>
                                            @else
                                                <td class="align-middle text-center text-sm">
                                                        <span
                                                            class="badge badge-sm bg-gradient-warning">{{ $authorized_purchase[2]->status }}</span>
                                                </td>
                                            @endif
                                        </tr>
                                        @endif
                                    @empty
                                        <tr>
                                            <td class="align-middle text-center text-sm">
                                                <p class="text-xs font-weight-bold mb-0">No Authorized Purchase</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                    ...
                                    <tr style="border-bottom:0px;">
                                        <th style="padding-left:30px; border-bottom:0px;"
                                            class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Name
                                        </th>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Customer</h6>
                            <div style="text-align:right;">
                                <a style="background-color:#f9a14d;" href="/customers" type="button"
                                   class="btn btn-primary btn-md"><i class="fa-solid fa-eye"></i>
                                    <span style="margin-left:5px;">View More</span></a>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table data-ordering="false" id="dashboard_customer_table"
                                       class="table align-items-center mb-0">
                                    <thead>
                                    <tr>
                                        <th style="border-bottom:1px solid rgb(200, 195, 195);"
                                    ...
                                    @foreach ($customers as $customer)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $customer->phone_number }}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $customer->id_number }}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                    <span
