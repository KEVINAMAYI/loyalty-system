...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->integer('another_contact_person_name')->nullable();
            $table->integer('another_contact_person_email')->nullable();
            $table->integer('another_contact_person_phone')->nullable();
            $table->integer('another_contact_person_alternative_phone')->nullable();
            $table->rememberToken();
            $table->timestamps();
        });
    }
